        ...
        <el-col :span="20"
          ><div class="grid-content">
            ...
            >
              ...
              <el-table-column prop="teamName" label="团队名称" width="170">
              </el-table-column>
              <el-table-column prop="projectName" label="赛事名称" width="170">
              </el-table-column>
              <el-table-column prop="projectLevel" label="赛事级别" width="170">
              </el-table-column>
              <el-table-column prop="teamPrice" label="获得奖项" width="170">
              </el-table-column>
              <el-table-column prop="teacherName" label="教师姓名" width="150">
              </el-table-column>
              <el-table-column prop="workTimeGet" label="工作量" width="150">
              </el-table-column>
            </el-table>
            <!-- 最底部按钮，提交 退回 备注 -->
